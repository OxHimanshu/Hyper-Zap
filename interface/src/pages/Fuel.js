...
function Fuel () {
    ...
    let Chainselect = () => {
        return (
        toggleChainList ? 
        <div className='drop-shadow-md bg-black rounded-lg absolute h-[480px] w-full text-white px-4'>
                    ...
                    <div className='relative h-3/4 w-2/4 flex items-center justify-center'>
                        <div>
                            <div className='border p-4 rounded-lg border-white border-4 bg-[#D631B9] space-y-4'>
                                <div className='flex'>
                                    <div className='cursor-not-allowed flex justify-center w-[250px] items-center px-2 rounded-lg bg-[#2362C0] font-semibold overflow-hidden'>{chainsDetails[chain.id].name}</div>
                                    ...
                                    <div className='font-light text-md text-gray-500 flex items-center mx-4'>----</div>
                                    <div onClick={() => setToggleChainList(!toggleChainList)} className='flex flex-row flex justify-center w-[250px] items-center px-2 rounded-lg bg-[#2362C0]'>
